 ...
 * MA 02110-1301  USA
 */
package se.skltp.adapterservices.ehr.accesscontrol.dominohttp10adapter;
...
public class DominoHttp10AdapterMuleServer {
	...
	private static final Logger logger = LoggerFactory.getLogger(DominoHttp10AdapterMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/DominoHttp10Adapter-common.xml"
        //
